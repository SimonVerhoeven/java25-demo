...
:xrefstyle: short
:experimental:
:description: A comprehensive overview of Java 25 LTS, covering new JEPs including AOT caching and profiling, compact object headers, Generational Shenandoah, structured concurrency, and primitive types in patterns.
:keywords: java 25, jdk 25, lts, aot caching, compact object headers, structured concurrency, primitive patterns, jep, openjdk
:copyright: Copyright (c) 2025 Simon Verhoeven
:license: MIT License
...
* Preview Features: APIs like StableValue and PEM encoding require --enable-preview flags and may evolve further. If you were running 22 and experimenting with StringTemplates, that preview was removed in Java23.
